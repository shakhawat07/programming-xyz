        ...
        <section className="m-5">
            <div className="py-4 container-fluid">
                <div className="row d-flex justify-content-start align-items-start py-3 mx-3 h-100 about-container rounded">
                    ...
                    <div className="col-lg-8 col-md-8 cl-sm-12 col-12">
                        <img style={{ width: '620px', height: '380px' }} src="https://candid.technology/wp-content/uploads/2019/11/Computer-programming-languages-coding-329090sd-java-python-php.jpg" alt="" />
                    </div>
                </div>
            </div>
        </section>
